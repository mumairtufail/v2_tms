            ...
            <div class="relative flex flex-col justify-between p-12 text-white z-10">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-8">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-2xl">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                            </svg>
                        </div>
                        <span class="text-2xl font-bold tracking-tight">TMS Platform</span>
                    </div>
                ...
                <div class="text-sm text-white/60">
                    &copy; {{ date('Y') }} TMS Platform. All rights reserved.
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center p-6 lg:p-12">
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden flex items-center justify-center gap-3 mb-8">
                    ...
                    <span class="text-xl font-bold text-white tracking-tight">TMS Platform</span>
                </div>
