...
<div class="container-fluid py-4">
    ...
    <x-breadcrumb 
        title="Edit Carrier" 
        subtitle="Update carrier information" 
        icon="fa-truck-moving">
        <li class="breadcrumb-item"><a href="{{ route('carriers.index') }}">Carriers</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit {{ $carrier->carrier_name ?? 'Carrier' }}</li>
    </x-breadcrumb>
            ...
            <form action="{{ route('carriers.update', $carrier->id) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('carrier_name') is-invalid @enderror"
                                name="carrier_name" value="{{ old('carrier_name', $carrier->carrier_name) }}" placeholder="Enter carrier name" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('dot_id') is-invalid @enderror"
                                name="dot_id" value="{{ old('dot_id', $carrier->dot_id) }}" placeholder="Enter DOT ID">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('docket_number') is-invalid @enderror"
                                name="docket_number" value="{{ old('docket_number', $carrier->docket_number) }}" placeholder="Enter docket number">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('address_1') is-invalid @enderror"
                                name="address_1" value="{{ old('address_1', $carrier->address_1) }}" placeholder="Enter address">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('city') is-invalid @enderror"
                                name="city" value="{{ old('city', $carrier->city) }}" placeholder="Enter city">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('state') is-invalid @enderror"
                                name="state" value="{{ old('state', $carrier->state) }}" placeholder="Enter state">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-select custom-select @error('country') is-invalid @enderror"
                                ...
                                <option value="US" {{ old('country', $carrier->country) == 'US' ? 'selected' : '' }}>United States</option>
                                <option value="CA" {{ old('country', $carrier->country) == 'CA' ? 'selected' : '' }}>Canada</option>
                                <option value="MX" {{ old('country', $carrier->country) == 'MX' ? 'selected' : '' }}>Mexico</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('post_code') is-invalid @enderror"
                                name="post_code" value="{{ old('post_code', $carrier->post_code) }}" placeholder="Enter postal code">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select custom-select @error('currency') is-invalid @enderror"
                                ...
                                <option value="USD" {{ old('currency', $carrier->currency) == 'USD' ? 'selected' : '' }}>USD</option>
                                <option value="CAD" {{ old('currency', $carrier->currency) == 'CAD' ? 'selected' : '' }}>CAD</option>
                                <option value="MXN" {{ old('currency', $carrier->currency) == 'MXN' ? 'selected' : '' }}>MXN</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" 
                                    {{ old('is_active', $carrier->is_active) ? 'checked' : '' }} style="width: 3em; height: 1.5em; margin-right: 1em;">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg px-4">
                        <i class="fa fa-save me-2"></i> <span>Update Carrier</span>
                    </button>
                </div>
            </form>
        </div>
