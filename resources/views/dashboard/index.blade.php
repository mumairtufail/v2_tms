					...
					<div class="card">
						...
						<div class="card-body">
							<div class="hk-legend-wrap mb-20">
								<div class="hk-legend">
									<span
										class="d-10 bg-indigo-light-2 rounded-circle d-inline-block"></span><span>A1</span>
								</div>
								<div class="hk-legend">
								...
								<div class="hk-legend">
									<span
										class="d-10 bg-indigo-light-1 rounded-circle d-inline-block"></span><span>A3</span>
								</div>
								<div class="hk-legend">
									<span
										class="d-10 bg-indigo-light-3 rounded-circle d-inline-block"></span><span>A4</span>
								</div>
							</div>
				...
				<div class="col-lg-4">
					<div class="card">
						...
						<div class="card-body">
							<div class="hk-legend-wrap mb-20">
								<div class="hk-legend">
									<span class="d-10 bg-primary rounded-circle d-inline-block"></span><span>Won
										Leads</span>
								</div>
								<div class="hk-legend">
									<span class="d-10 bg-indigo-light-1 rounded-circle d-inline-block"></span><span>Lost
										Leads</span>
								</div>
							</div>
					...
					<div class="card card-refresh">
						...
						<div class="card-body">
							<div class="hk-legend-wrap mb-20">
								...
								<div class="hk-legend">
									<span
										class="d-10 bg-indigo-light-3 rounded-circle d-inline-block"></span><span>Impressions</span>
								</div>
							</div>
				...
				<div class="col-lg-4">
					<div class="card">
						<div class="card-header card-header-action">
							<h6>Risk</h6>
							<div class="d-flex align-items-center card-action-wrap">
								<div class="toggle toggle-sm toggle-simple toggle-light toggle-bg-primary risk-switch">
								</div>
							</div>
						</div>
						<div class="card-body">
							...
							<div class="hk-legend-wrap mt-20 mb-5">
								<div class="hk-legend">
									<span class="d-10 bg-indigo-light-1 rounded-circle d-inline-block"></span><span>Net
										Search</span>
								</div>
								<div class="hk-legend">
									<span class="d-10 bg-primary rounded-circle d-inline-block"></span><span>Email
										Search</span>
								</div>
							</div>
							<div class="hk-legend-wrap">
								<div class="hk-legend">
									<span
										class="d-10 bg-indigo-light-2 rounded-circle d-inline-block"></span><span>Direct
										Search</span>
								</div>
								<div class="hk-legend">
									<span class="d-10 bg-indigo-light-3 rounded-circle d-inline-block"></span><span>Paid
										Search</span>
								</div>
							</div>
						</div>
