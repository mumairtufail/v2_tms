...
@php
    ...
    $settingsCards = [
        [
            'title'       => 'Branding & Logo',
            'description' => 'Upload light and dark mode logos for your workspace.',
            'route'       => route('v2.settings.branding', $company),
            'icon'        => 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z',
            'tag'         => 'Branding',
        ],
        [
            'title'       => 'Email (SMTP)',
            'description' => 'Connect the email account used to send password resets and notifications.',
            'route'       => route('v2.settings.smtp.index', $company),
            'icon'        => 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
            'tag'         => 'Email',
        ],
        [
            'title'       => 'Plugins',
            'description' => 'Manage connected integrations and automation modules.',
            'route'       => route('v2.plugins.index', $company),
            'icon'        => 'M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z',
            'tag'         => 'Integrations',
        ],
        [
            'title'       => 'Roles & Permissions',
            'description' => 'Manage access controls, roles, and feature permissions.',
            'route'       => route('v2.roles.index', $company),
        ...
        [
            ...
            'route'       => $currentCompany ? route('v2.profile.edit', ['company' => $company->slug]) : route('profile.edit'),
...
<div class="space-y-4" x-data="settingsHub()" x-init="init()">
    <x-v2-breadcrumb :items="[
        ['label' => 'Dashboard', 'url' => route('v2.dashboard', $company)],
        ['label' => 'Settings']
    ]" />

    <div class="flex items-center justify-between gap-4">
        <x-page-header title="Settings" description="Manage company preferences." />
